...
{
    public class BdpfMcsubunitsController : Controller
    {
        private readonly BD_Context _context;

        public BdpfMcsubunitsController(BD_Context context)
        {
            _context = context;
        }
        ...
        {
            var bD_Context = _context.BdpfMcsubunits.Include(b => b.SubMcunitNavigation);
